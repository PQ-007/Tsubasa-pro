...
export const cardsData = [
  {
    ...
    description: "Brute Force нь бүх боломжит шийдлүүдийг шалгаж, хамгийн оновчтой шийдлийг олох энгийн бөгөөд найдвартай арга юм.",
...
4. Шийдлийн зөв эсэхийг шалгахад ашигла`,
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Brute Force алгоритм нь бүх боломжит шийдлүүдийг туршиж үзэх замаар ажилладаг."
        },
        {
          id: 2,
        ...
        {
          id: 3,
          question: "n хотын худалдаачны асуудлыг Brute Force шийдэхэд хамгийн муу тохиолдолд ямар цаг зарцуулах вэ?",
          options: [
            "O(n^2)",
            "O(n!)",
            "O(2^n)",
          ...
          correctAnswer: 1,
          explanation: "Худалдаачны асуудлын Brute Force шийдэл нь O(n!) цаг зарцуулдаг."
        },
        {
          id: 4,
          ...
          correctAnswer: 2,
          explanation: "Brute Force алгоритмын гол сул тал нь том оролтын хэмжээтэй үед маш их тооцоолол шаарддаг."
        },
        {
          id: 5,
          question: "Аль тохиолдолд Brute Force алгоритм хамгийн тохиромжтой вэ?",
          options: [
          ...
          correctAnswer: 2,
          explanation: "Brute Force алгоритм нь нууц үгийн урт болон тэмдэгтийн олонлог бага үед тохиромжтой."
        },
        {
          id: 6,
          question: "Brute Force алгоритм нь том хэмжээний асуудлуудад үр ашиггүй гэж үздэг үү?",
          options: [
            "Тийм",
            "Үгүй"
          ],
          correctAnswer: 0,
          explanation: "Тийм, учир нь том хэмжээний ас��удлуудад тооцооллын зардал экспоненциал хэлбэрээр өсдөг."
        }
      ]
    }
  },
  {
    ...
    description: "Үйлдлийн системийн үндсэн ойлголт, процесс, thread, санах ой, файлын систем гэх мэт чухал сэдвүүдийг судлах болно.",
...
- Файлын системийн оновчтой ашиглалт`,
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Үйлдлийн систем нь техник ба программ хангамжийн хоорондын зохицуулагч юм."
        },
        {
          id: 2,
          ...
          correctAnswer: 2,
          explanation: "Thread нь процессын хүрээнд хуваалцсан санах ойг ашигладаг."
        }
      ]
    }
  ...
  },
  {
    ...
    description: "Дискрет математик нь тоон утгатай функц, олонлог, логик, граф зэрэг салангид бүтцүүдийг судалдаг математикийн салбар юм.",
    lessons: 1,
    quizzes: 1,
    author: "Т. Мөнхбат",
    category: "Математик",
...
4. Модуль арифметикийн бодлогууд`,
    quiz1: {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "Анхны тоо нь тоон онолын үндсэн ойлголтуудын аль нь юм."
        },
        {
          id: 3,
          ...
          correctAnswer: 1,
          explanation: "Компьютерийн шинжлэх ухаан нь дискрет математикийн хэрэглээний аль нь юм."
        },
        {
          id: 4,
          ...
          correctAnswer: 1,
          explanation: "Олонлогийн үйлдлүүд нь дискрет математикийн дасгал ажлуудын аль нь юм."
        }
      ]
    }
  },
  {
    ...
    description: "Компьютерийн сүлжээ нь хоёр буюу түүнээс дээш компьютер, төхөөрөмжүүдийг хооронд нь холбож, мэдээлэл солилцох боломжийг олгодог систем юм.",
    lessons: 1,
    quizzes: 1,
    author: "А. Мөнхбаяр",
    category: "Сүлжээ",
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "TCP/IP протокол нь 4 үндсэн давхаргатай: Хэрэглээний, Тээврийн, Интернэт, болон Сүлжээний интерфейс давхарга."
        },
        {
          id: 2,
          question: "Дараах сүлжээний төрлүүдээс аль нь хамгийн өргөн хүрээг хамардаг вэ?",
          options: [
            "LAN",
            "MAN",
            "WAN",
          ...
          correctAnswer: 2,
          explanation: "WAN (Wide Area Network) буюу Өргөн хүрээний сүлжээ нь хамгийн том газар нутгийг хамардаг."
        },
        {
          id: 3,
          ...
          correctAnswer: 2,
          explanation: "IPv4 хаяг нь 4 октет бүхий тоонуудаас бүрддэг (0-255 хүртэл). 192.168.1.1 нь зөв форматтай IPv4 хаяг юм."
        },
        {
          id: 4,
          question: "Аль төхөөрөмж нь сүлжээний аюулгүй байдлыг хангахад ашиглагддаг вэ?",
          options: [
            "Hub",
            "Switch",
            "Firewall",
          ...
          correctAnswer: 2,
          explanation: "Firewall (Галт хана) нь сүлжээний аюулгүй байдлыг хангах үндсэн төхөөрөмж юм."
        },
        {
          id: 5,
          ...
          correctAnswer: 1,
          explanation: "LAN (Local Area Network) буюу Орон нутгийн сүлжээ нь нэг байршил дахь компьютеруудыг холбодог сүлжээ юм."
        }
      ]
    },
    quiz2: {
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Router нь өөр өөр сүлжээнүүдийг холбож, тэдгээрийн хооронд өгөгдөл дамжуулах үүрэгтэй."
        },
        {
          id: 2,
          ...
          correctAnswer: 2,
          explanation: "Switch нь MAC хаягийг ашиглан өгөгдлийг зөв хүлээн авагч руу шууд дамжуулдаг."
        },
        {
          id: 3,
          question: "Сүлжээний аюулгүй байдлын хамгийн чухал элемент аль нь вэ?",
          options: [
          ...
          correctAnswer: 2,
          explanation: "Нууцлалын протокол нь сүлжээний аюулгүй байдлын үндсэн элемент бөгөөд өгөгдлийн нууцлал, бүрэн бүтэн байдлыг хангадаг."
        }
      ]
    }
  },
...
4. Технологийн оновчлол`,
      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: "Шугаман функц y = ax + b нь шулуун шугаман график үүсгэдэг."
        },
        {
          id: 2,
    ...
    quiz2: {
      ...
      questions: [
        ...
        },
        {
          ...
          correctAnswer: 1,
          explanation: "Экспоненциал функцийг хүн амын өсөлт, бактерийн өсөлт зэрэг экспоненциал өсөлтийг загварчлахад өргөн хэрэглэдэг."
        },
        {
          id: 3,
          ...
          correctAnswer: 0,
          explanation: "Логарифм функцийг газар хөдлөлтийн хүчийг хэмжих Рихтерийн шаталбарт ашигладаг."
        }
      ]
    }
  },
  {
    ...
    description: "Энтропи ба термодинамикийн хуулиуд, тэдгээрийн бодит хэрэглээ",
    lessons: 1,
    quizzes: 2,
    author: "Ц. Золбадрал",
    category: "Физик",
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Энтропи нь системийн эмх замбараагүй байдлын хэмжүүр юм."
        },
        {
          id: 2,
          ...
          correctAnswer: 2,
          explanation: "Термодинамикийн 2-р хуулиар хаалттай системд энтропи үргэлж нэмэгддэг."
        },
        {
          id: 3,
          ...
          correctAnswer: 1,
          explanation: "k нь Больцманы тогтмол бөгөөд энтропийн тооцоололд чухал үүрэгтэй."
        }
      ]
    },
    quiz2: {
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Мөс хайлах үед системийн эмх замбараагүй байдал нэмэгддэг."
        },
        {
          id: 2,
          ...
          correctAnswer: 1,
          explanation: "Шеннонгийн энтропи нь мэдээллийн системийн тодорхойгүй байдлыг хэмждэг."
        },
        {
          id: 3,
          ...
          correctAnswer: 2,
          explanation: "Хар нүхний энтропи нь мэдээллийн парадоксыг үүсгэдэг бөгөөд квант механик, ерөнхий харьцангуйн онолын хооронд зөрчил үүсгэдэг."
        }
      ]
    }
  },
...
- N1 - Мэргэжлийн шат`,
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "おはようございます (Ohayou gozaimasu) нь өглөөний мэнд гэсэн үг."
        },
        {
          id: 2,
          question: "Япон хэлний ямар бичиг үсэг гадаад үгийг бичихэд хэрэглэгддэг вэ?",
          options: [
            "Хирагана",
            "Катакана",
            "Ханз",
          ...
          correctAnswer: 1,
          explanation: "Катакана нь гадаад үг, нэр болон онцгой үгсийг бичихэд хэрэглэгддэг."
        },
        {
          id: 3,
          ...
          correctAnswer: 1,
          explanation: "は (wa) нь өгүүлбэрийн сэдвийг заах үүрэгтэй жижиг үг юм."
        }
      ]
    },
    quiz2: {
      ...
      questions: [
        {
          ...
          correctAnswer: 2,
          explanation: "ありがとうございます (Arigatou gozaimasu) нь баярлалаа гэсэн үг."
        },
        {
          id: 2,
          ...
          correctAnswer: 3,
          explanation: "N1 нь Япон хэлний чадварын түвшин тогтоох JLPT шалгалтын хамгийн өндөр түвшин юм."
        },
        {
          id: 3,
          ...
          correctAnswer: 1,
          explanation: "Япон хэлэнд Хирагана, Катакана, Ханз гэсэн 3 төрлийн бичиг үсэг байдаг."
        }
      ]
    }
  },
  {
    ...
    description: "Enhance your English skills with advanced grammar, vocabulary, and communication techniques.",
    lessons: 1,
    quizzes: 2,
    author: "А. Даваа",
    category: "Language",
      ...
      questions: [
        {
          ...
          correctAnswer: 2,
          explanation: "The present perfect tense is used to indicate an action that occurred at an unspecified time."
        },
        {
          id: 2,
          ...
          correctAnswer: 0,
          explanation: "'Break the ice' means to initiate conversation in a social setting, especially among strangers."
        },
        {
          id: 3,
          ...
          correctAnswer: 2,
          explanation: "The modal verb 'must' indicates a strong assumption or certainty about something."
        }
      ]
    },
    quiz2: {
      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: "A relative clause provides additional information about a noun in the sentence."
        },
        {
          id: 2,
          question: "Which of the following is an example of a conditional sentence?",
          options: [
          ...
          correctAnswer: 0,
          explanation: "Conditional sentences express a condition and its possible outcome."
        },
        {
          id: 3,
          question: "What is the best way to engage an audience during a speech?",
          options: [
          ...
          correctAnswer: 1,
          explanation: "Engaging an audience involves making eye contact and interacting with them."
        },
        {
          id: 4,
          question: "Which tense is used to describe an action that has been completed at some indefinite time in the past?",
          options: [
            "Past Simple",
            "Present Perfect",
            "Future Perfect",
          ...
          correctAnswer: 1,
          explanation: "The Present Perfect tense is used to describe actions that occurred at an unspecified time before now."
        },
        {
          id: 5,
